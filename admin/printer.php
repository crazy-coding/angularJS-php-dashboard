...
// Set Document Title
$document->setTitle($language->get('title_printer'));
...
<div class="content-wrapper" ng-controller="PrinterController">
  ...
  <section class="content-header">
    <h1>
      <?php echo $language->get('text_printer_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
  ...
  <section class="content">
    ...
    <?php if ($user->getGroupId() == 1 || $user->hasPermission('access', 'create_printer')) : ?>
      <div class="box box-info<?php echo create_box_state(); ?>">
        <div class="box-header with-border">
          <h3 class="box-title">
            <span class="fa fa-fw fa-plus"></span> <?php echo $language->get('text_new_printer_title'); ?>
          </h3>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo $language->get('text_printer_list_title'); ?>
            </h3>
          </div>
          <div class="box-body">
            <div class="table-responsive">  
              <?php
                ...
                if ($user->getGroupId() != 1) {
                  if (!$user->hasPermission('access', 'update_printer')) {
                    $hide_colums .= "7,";
                  }
                  if (!$user->hasPermission('access', 'delete_printer')) {
                    $hide_colums .= "8,";
                  }
                }
              ?> 
