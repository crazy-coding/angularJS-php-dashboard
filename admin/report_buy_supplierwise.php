...
// Add Script
$document->addScript('../assets/itsolution24/angular/controllers/ReportBuySupplierWiseController.js');
...
<div class="content-wrapper" ng-controller="ReportBuySupplierWiseController">
              ...
              <table id="report-report-list" class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>" data-print-columns="<?php echo $print_columns;?>">
                <thead>
                  <tr class="bg-gray">
                    ...
                    <th class="w-40">
                      <?php echo $language->get('label_sup_name'); ?>
                    </th>
                    <th class="w-10">
