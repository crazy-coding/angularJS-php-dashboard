...
if ($user->getGroupId() != 1 && !$user->hasPermission('access', 'read_sell_payment_report')) {
...
// Set Document Title
$document->setTitle($language->get('title_sell_payment_report'));
...
<div class="content-wrapper" ng-controller="ReportSellPaymentController">
  ...
  <section class="content-header">
    ...
    <h1>
      <?php echo $language->get('text_sell_payment_report_title'); ?>
      <small>
        <?php echo store('name'); ?>   
      </small>
    </h1>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo $language->get('text_sell_payment_report_sub_title'); ?>
            </h3>
          </div>
          <div class="box-body">
