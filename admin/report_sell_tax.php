...
// Set Document Title
$document->setTitle($language->get('title_sell_tax_report'));
...
<div class="content-wrapper" ng-controller="ReportSellTaxController">
  ...
  <section class="content-header">
    ...
    <h1>
      <?php echo $language->get('text_sell_tax_report_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo $language->get('text_tax_report_sub_title'); ?>
            </h3>
          </div>
          <div class="box-body">
              ...
              <table id="report-report-list" class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>" data-print-columns="<?php echo $print_columns;?>">
                <thead>
                  <tr class="bg-gray">
                    ...
                    <th class="w-20">
                      <?php echo $language->get('label_total_amount'); ?>
                    </th>
                  </tr>
                </thead>
                <tfoot>
