...
// Set Document Title
$document->setTitle($language->get('title_unit'));
...
<div class="content-wrapper" ng-controller="UnitController">
  ...
  <section class="content-header">
    <h1>
      <?php echo $language->get('text_unit_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
    ...
    <?php if ($user->getGroupId() == 1 || $user->hasPermission('access', 'create_unit')) : ?>
      <div class="box box-info<?php echo create_box_state(); ?>">
        <div class="box-header with-border">
          <h3 class="box-title">
            <span class="fa fa-fw fa-plus"></span> <?php echo $language->get('text_new_unit_title'); ?>
          </h3>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo $language->get('text_unit_list_title'); ?>
            </h3>
          </div>
          <div class="box-body">
              ...
              <table id="unit-unit-list" class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>">
                <thead>
                  <tr class="bg-gray">
                    ...
                    <th class="w-30" >
                      <?php echo $language->get('label_unit_name'); ?>
                    </th>
                    <th class="w-5">
