...
if ($user->getGroupId() != 1 && !$user->hasPermission('access', 'read_customer_due_collection_report')) {
...
<div class="content-wrapper" ng-controller="ReportCustomerDueCollectionController">
	...
	<section class="content-header">
	  ...
	  <h1>
	    <?php echo $language->get('text_due_collection_title'); ?>
	    <small>
	    	<?php echo store('name'); ?>
	    </small>
	  </h1>
		    ...
		    <div class="col-xs-12">
		      	<div class="box box-info">
		      		<div class="box-header">
				        <h3 class="box-title">
				        	<?php echo $language->get('text_due_collection_sub_title'); ?>
				        </h3>
				     </div>
			      	<div class='box-body'>  
