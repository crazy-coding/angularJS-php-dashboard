...
<form id="create-pmethod-form" class="form-horizontal" action="pmethod.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text" class="form-control" id="pmethod_name" value="<?php echo isset($request->post['pmethod_name']) ? $request->post['pmethod_name'] : null; ?>" name="pmethod_name" required>
      </div>
    </div>
